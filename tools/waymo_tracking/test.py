...
def parse_args():
    ...
    parser.add_argument('--checkpoint', help='the path to prediction file')
...
def main():
    ...
    print('Total track object:', tracker.id_count)
    ...
    print('waymo-open-dataset/bazel-bin/waymo_open_dataset/metrics/tools/compute_tracking_metrics_main {}  {} '.format(result_path, gt_path))
    
    # os.system('waymo_open_dataset/metrics/tools/compute_tracking_metrics_main {}  {} '.format(result_path, gt_path))
