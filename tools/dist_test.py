...
def parse_args():
    ...
    parser = argparse.ArgumentParser(description='Train a 3D object detector.')
    ...
    parser.add_argument('--mytrain', action='store_true')
...
def main():
    ...
    if args.testset:
        ...
        print('Use Train Set')
        dataset = build_dataset(cfg.data.mytrain)
    else:
        print('Use Val Set')
